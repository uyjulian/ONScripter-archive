...
private:
    ...
    struct DelayedInfo *start_delayed_effect_info;
    struct ButtonLink root_button_link, *last_button_link, current_over_button_link, *shelter_button_link;
    ...
    bool text_char_flag;
    TTF_Font *text_font;
    struct FontInfo sentence_font;
    bool new_line_skip_flag;
    int text_speed_no;
    int default_text_speed[3];

    void drawChar( char* text, struct FontInfo *info, bool flush_flag = true, bool not_selected_flag = false, SDL_Surface *surface = NULL );
