...
#else
#define MESSAGE_SAVE_EXIST "%s%sÅ@%såé%sì˙%séû%sï™"
#define MESSAGE_SAVE_EMPTY "%s%sÅ@Å|Å|Å|Å|Å|Å|Å|Å|Å|Å|Å|Å|"
#define MESSAGE_SAVE_CONFIRM "%s%sÇ…ÉZÅ[ÉuÇµÇ‹Ç∑ÅBÇÊÇÎÇµÇ¢Ç≈Ç∑Ç©ÅH"
#define MESSAGE_LOAD_CONFIRM "%s%sÇÉçÅ[ÉhÇµÇ‹Ç∑ÅBÇÊÇÎÇµÇ¢Ç≈Ç∑Ç©ÅH"
#define MESSAGE_RESET_CONFIRM "ÉäÉZÉbÉgÇµÇ‹Ç∑ÅBÇÊÇÎÇµÇ¢Ç≈Ç∑Ç©ÅH"
#define MESSAGE_END_CONFIRM "èIóπÇµÇ‹Ç∑ÅBÇÊÇÎÇµÇ¢Ç≈Ç∑Ç©ÅH"
#define MESSAGE_YES "ÇÕÇ¢"
#define MESSAGE_NO "Ç¢Ç¢Ç¶"
#define MESSAGE_OK "ÇnÇj"
#define MESSAGE_CANCEL "ÉLÉÉÉìÉZÉã"
#endif
